                    ...
                    <li class="list-group-item current-appointment">
                      <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                        ...
                        <p class="mb-1 status" style="background-color: 
                          ...
                          <p class="mb-1"><span class="fw-bold">Payment Method:</span> <?php echo $row['payment_option']; ?></p>
                          <p class="mb-1"><span class="fw-bold">Total Amount: ₱</span><?php echo $row['payment']; ?></p>
