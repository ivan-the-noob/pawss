    ...
    <div class="container mt-4">
        ...
        <!-- Responsive Order Buttons -->
        <div class="order-button d-flex flex-wrap gap-1 mt-4 justify-content-center">
            <button class="button-highlight btn btn-sm py-2 px-3 mb-2" onclick="showSection('orders')">Orders</button>
            <button class="btn btn-outline-secondary btn-sm py-2 px-3 mb-2" onclick="showSection('to-ship')">To Ship</button>
            <button class="btn btn-outline-secondary btn-sm py-2 px-3 mb-2" onclick="showSection('to-receive')">To Receive</button>
            <button class="btn btn-outline-secondary btn-sm py-2 px-3 mb-2" onclick="showSection('received-orders')">Received Orders</button>
            <button class="btn btn-outline-secondary btn-sm py-2 px-3 mb-2" onclick="showSection('cancelled-orders')">Cancelled Orders</button>
        </div>
        </div>
    <?php
    ...
    <?php foreach ($groupedOrders as $createdAt => $ordersGroup): ?>
                <div class="card p-3 mt-4">
                    <div class="d-flex flex-wrap gap-1 mb-3 justify-content-end">
                        <p class="p-2 pending mb-2">Pending</p>
                        <button type="button" class="success-btn btn btn-sm btn-success mb-2" data-bs-toggle="modal" data-bs-target="#buyAgainModal">
                            Buy Again
                        </button>
                        <button class="cancel btn btn-sm btn-danger mb-2" data-id="<?php echo htmlspecialchars($ordersGroup[0]['id']); ?>">Cancel</button>
                            ...
                            ?>
                                <div class="row mb-2">
                                    <div class="col-md-2 col-4">
                                        <img src="../../../../assets/img/product/<?php echo htmlspecialchars($order['product_img']); ?>" alt="Product Image" class="img-fluid w-100" style="border-radius: 10px;" />
                                    </div>
                                    <div class="col-md-7 col-8">
                                        <h5 class="card-title mb-1 fs-6"><?php echo htmlspecialchars($order['product_name']); ?></h5>
                                        <p class="mb-0 small">Quantity: <?php echo htmlspecialchars($order['quantity']); ?></p>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-6 mb-3">
                                        <div class="card h-100">
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                <h5 class="card-title fs-6"><?php echo htmlspecialchars($order['product_name']); ?></h5>
                                                <form action="../../function/php/buyagain.php" method="post" class="mt-auto">
    ...
    <div class="to-ship">
        <?php if (!empty($to_ship_orders)): ?>
            ...
            <?php foreach ($groupedToShipOrders as $createdAt => $ordersGroup): ?>
                <div class="card p-3 mt-4">
                    <div class="d-flex flex-wrap gap-1 mb-3 justify-content-end">
                        <p class="p-2 to-ship-w mb-2">To Ship</p>
                    </div>
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <?php
    ...
    <div class="to-receive">
        <?php if (!empty($to_receive_orders)): ?>
            ...
            <?php foreach ($groupedToReceiveOrders as $createdAt => $ordersGroup): ?>
                <div class="card p-3 mt-4">
                    <div class="d-flex flex-wrap gap-1 mb-3 justify-content-end">
                            <p class="p-2 to-receive-w mb-2">To Receive</p>
                            <form action="../../function/php/update-receive.php" method="POST" onsubmit="return confirm('Mark all items as received?');" class="mb-2">
    ...
    <div class="received-orders">
        <?php if (!empty($completed_orders)): ?>
            ...
            <?php foreach ($groupedCompletedOrders as $createdAt => $ordersGroup): ?>
                ...
                <div class="card p-3 mt-4">
                    <div class="d-flex flex-wrap gap-1 mb-3 justify-content-between align-items-center">
                        <p class="p-2 completed-orders mb-0 mb-2">Completed Orders</p>
    ...
    <div class="cancelled-orders">
        <?php if (!empty($cancelled_orders)): ?>
            ...
            <?php foreach ($groupedCancelledOrders as $createdAt => $ordersGroup): ?>
                <div class="card p-3 mt-4">
                    <div class="d-flex flex-wrap gap-1 mb-3 justify-content-end">
                        <p class="p-2 cancelled-order mb-2">Cancelled Orders</p>
                    </div>
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            <?php
